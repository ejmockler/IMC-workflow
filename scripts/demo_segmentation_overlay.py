#!/usr/bin/env python3
"""
Demo: render a segmentation-overlay plot with quality metrics in the title.

This is a standalone script that generates synthetic DNA composite + SLIC
labels and invokes ``src.viz_utils.plotting.plot_segmentation_overlay`` for
visual inspection. It is NOT a pytest test — it has no assertions, saves
a PNG as a side effect, and uses hardcoded data.

Moved from tests/ on 2026-04-21. Run directly:

    .venv/bin/python scripts/demo_segmentation_overlay.py

Output: plots/validation/test_quality_metrics.png
"""
