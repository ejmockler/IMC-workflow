...
**Family B (continuous neighborhood deltas) produced no endpoint clearing |g_shrunk_neutral| > 0.5 at Sham→D7 in this cohort.** Pre-registered and run; not omitted. The absence of Family B headlines is itself a result.
