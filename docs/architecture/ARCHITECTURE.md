...
- Consumes per-ROI annotation parquets; emits **22 parquets** + `endpoint_summary.csv` (**840 rows × 46 cols** post-remediation) + `continuous_sham_pct_sweep.csv` + `family_b_raw_marker_comparison.csv` + `run_provenance.json`
