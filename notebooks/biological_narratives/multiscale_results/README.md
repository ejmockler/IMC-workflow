...
The reviewer-facing analysis is in `results/biological_analysis/temporal_interfaces/endpoint_summary.csv` (1134 rows × 46 cols, post-Phase-7) and `results/biological_analysis/spatial_neighborhoods/temporal_neighborhood_enrichments.csv` (current cell-type-pair enrichments). Treat the files in this directory as historical artifacts only.
