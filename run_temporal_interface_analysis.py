...
def assemble_endpoint_summary(
    ...
    # passes the v1 rule. Runtime cohort (post-remediation, spec-literal gate):
    # 5 unique demoted endpoint roots producing 18 row-level demotions out of
    # 840 total endpoint rows. The architecture is correct for the events that
    # exist; reach is small because few v2 events have a v1 lineage analog
    # passing the v1 rule on the same biological event.
    v2_to_v1_lineage = {
